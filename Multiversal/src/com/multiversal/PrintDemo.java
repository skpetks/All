...
public class PrintDemo extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		act2MyValue = bundle.getString("Bluetooth_text");
	...
	public void onStart() {
		...
		try {
			...
			edtContext.setText(act2MyValue);
	...
	class ClickEvent implements View.OnClickListener {
		public void onClick(View v) {
			if (v == btnSearch) {
				Intent serverIntent = new Intent(PrintDemo.this,
						DeviceListActivity.class); // 运行另外一个类的活动
				startActivityForResult(serverIntent, REQUEST_CONNECT_DEVICE);
			} else if (v == btnSend) {
				String msg = edtContext.getText().toString().trim();// act2MyValue;
				if (msg.length() > 0) {
